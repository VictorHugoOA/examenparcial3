...
const ctrlDatos = 
{
    findState: async (req, res) =>
    {
        ...
        res.json({clave: data.data.datos[0].cve_agee, nombre: data.data.datos[0].nom_agee, poblacion: data.data.datos[0].pob, femenina: data.data.datos[0].pob_fem, masculina: data.data.datos[0].pob_mas, viviendas: data.data.datos[0].viv});
    },
